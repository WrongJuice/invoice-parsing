...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $BandeDessinees[0]->setEstPopulaire(true);
        ...
        $BandeDessinees[4]->setEstPopulaire(true);
        ...
        $BandeDessinees[5]->setEstPopulaire(true);
        ...
        $BandeDessinees[6]->setEstPopulaire(true);
        ...
        $BandeDessinees[7]->setEstPopulaire(true);
        ...
        $BandeDessinees[8]->setEstPopulaire(true);
        ...
        $BandeDessinees[12]->setEstPopulaire(true);
        ...
        $BandeDessinees[13]->setEstPopulaire(true);

        // Crée 1 COmics de Policier Tendance
        ...
        $BandeDessinees[14]->setGenre('Comics');
        ...
        $BandeDessinees[14]->setEstPopulaire(true);
        ...
        $BandeDessinees[15]->setEstPopulaire(true);
        ...
        $BandeDessinees[16]->setEstPopulaire(true);
        ...
        $BandeDessinees[20]->setEstPopulaire(true);
        ...
        $BandeDessinees[21]->setGenre('Mangas');
        ...
        $BandeDessinees[21]->setEstPopulaire(true);
        ...
        $BandeDessinees[22]->setEstPopulaire(true);
        ...
        $BandeDessinees[23]->setEstPopulaire(true);
        ...
        copy('public/data_fixtures/affiche_Comics6.jpg' , 'public/data/' . $BandeDessinees[21]->getId() . '/affiche.jpg');
        ...
        copy('public/data_fixtures/affiche_Comics7.jpg' , 'public/data/' . $BandeDessinees[22]->getId() . '/affiche.jpg');
